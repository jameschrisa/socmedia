  ...
  webServer: [
    {
      ...
      command: `PORT=${API_PORT} DATA_DIR=./data/e2e CLIENT_URL=${WEB_BASE_URL} ADMIN_EMAIL=${OWNER_EMAIL} ADMIN_PASSWORD=${OWNER_PASSWORD} ADMIN_NAME=${OWNER_NAME} npx tsx server/src/index.ts`,
